...
func main() {
	...
	fmt.Println("The longest sub string for", firstString, "and", secondString, ",result:", substring, "with length:", length)
}

// Welcome to the playground!
// The longest sub string for bdefg and abcefgh ,result: efg with length: 3